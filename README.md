...
Evaluation testbed (**IoT Virtual Lab**) accompanying the APIOT manuscript submitted to *Computers & Security*.

Companion agent artifact: https://github.com/Adelsamir01/apiot
...
## License (legacy heading removed below)
